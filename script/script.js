...
textarea.addEventListener("input", (e) => {
  ...
  muneco.style.display = "none"; // Oculta la imagen de Batman
  carga.classList.remove("hidden"); // Muestra el loader
  resulttitle.textContent = ""; // Limpia el título del resultado
  resultadotext.textContent = ""; // Limpia el texto del resultado
});
...
buttonencrip.addEventListener("click", (e) => {
  ...
  muneco.style.display = "none"; // Asegúrate de que la imagen de Batman esté oculta
